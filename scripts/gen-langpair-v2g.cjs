...
const SRC = 'C:/Users/Administrator/.openclaw-autoclaw/agents/agent-p6qd/workspace/projects/aifanyi/research/langpair-v2-batchG-20260921.json';
const OUT = path.join(TMP, 'langpair-v2G-full.json');
const PROG = path.join(TMP, 'langpair-v2G-progress.json');
...
const CFG = JSON.parse(fs.readFileSync(path.join(TMP, 'v2g-config.json'), 'utf8'));
