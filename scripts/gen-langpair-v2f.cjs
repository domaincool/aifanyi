...
const SRC = 'C:/Users/Administrator/.openclaw-autoclaw/agents/agent-p6qd/workspace/projects/aifanyi/research/langpair-v2-batchF-20260919.json';
const OUT = path.join(TMP, 'langpair-v2F-full.json');
const PROG = path.join(TMP, 'langpair-v2F-progress.json');
...
const CFG = JSON.parse(fs.readFileSync(path.join(TMP, 'v2f-config.json'), 'utf8'));
...
const SLUG_OVERRIDE = { '锅气': 'wok-hei' };
