...
const LANG_WHITELIST = ['zh-CN', 'zh', 'en', 'ja', 'ko', 'th', 'fr', 'it', 'de', 'es', 'ru', 'pt', 'da', 'sv', 'fil', 'tr', 'id']; // pt/da/sv/fil/tr/id: untranslatable 批（Saudade/Hygge/Lagom/Kilig/Huzun/Jalan-jalan）
