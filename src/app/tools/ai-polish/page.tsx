    ...
    <div className="tools-page">
          ...
          "mainEntity": [
            {
              ...
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "游客每日 30 次 / 5000 字符内可免费使用文本润色；登录后按积分计费（每千字 20 积分），新用户注册送 500 积分，可在翻译、润色、文件翻译间通用。"
              }
            },
            {
              "@type": "Question",
      ...
      <section className="pdf-seo-faq" id="faq" style={{ marginTop: 32 }}>
        ...
        <div className="pdf-seo-faq-item">
          <h3>AI 润色免费吗？</h3>
          <p>游客每日 30 次 / 5000 字符内可免费使用文本润色；登录后按积分计费（每千字 20 积分），新用户注册送 500 积分，可在翻译、润色、文件翻译间通用。</p>
        </div>
        <div className="pdf-seo-faq-item">
          <h3>润色和翻译有什么区别？</h3>
