    ...
    <div className="pdf-page">
      ...
      <section className="pdf-seo">
            ...
            "mainEntity": [
              {
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "免费在线使用。无需登录每天可翻译 5 个文件 / 50 页，登录后每天 10 个文件 / 100 页，次日自动恢复。"
                }
              },
              {
                "@type": "Question",
        ...
        <div className="pdf-seo-faq">
          <div className="pdf-seo-faq-item"><h3>免费吗？有次数限制吗？</h3><p>免费在线使用。无需登录每天可翻译 5 个文件 / 50 页，登录后每天 10 个文件 / 100 页，次日自动恢复。</p></div>
