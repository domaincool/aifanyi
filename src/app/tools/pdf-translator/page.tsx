    ...
    <div className="pdf-page">
      ...
      <section className="pdf-seo">
            ...
            "mainEntity": [
              {
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "新用户注册送 500 积分，按页数计积分（每页 20 积分）；游客每日可先试 5 个文件 / 50 页，注册后升至 10 个文件 / 100 页，每日自动重置。"
                }
              },
              {
                "@type": "Question",
        ...
        <div className="pdf-seo-faq">
          <div className="pdf-seo-faq-item"><h3>免费吗？有次数限制吗？</h3><p>新用户注册送 500 积分，按页数计积分（每页 20 积分）；游客每日可先试 5 个文件 / 50 页，注册后升至 10 个文件 / 100 页，每日自动重置。</p></div>
