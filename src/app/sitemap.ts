...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${BASE}/understand`, lastModified: now, changeFrequency: 'daily', priority: 0.9 },
    { url: `${BASE}/understand/meaning`, lastModified: now, changeFrequency: 'weekly', priority: 0.8 },
    ...
    { url: `${BASE}/languages/japanese`, lastModified: now, changeFrequency: 'weekly', priority: 0.8 },
    { url: `${BASE}/languages/korean`, lastModified: now, changeFrequency: 'weekly', priority: 0.8 },
    { url: `${BASE}/languages/english`, lastModified: now, changeFrequency: 'weekly', priority: 0.8 },
    { url: `${BASE}/languages/french`, lastModified: now, changeFrequency: 'weekly', priority: 0.8 },
    { url: `${BASE}/languages/german`, lastModified: now, changeFrequency: 'weekly', priority: 0.8 },
    { url: `${BASE}/languages/italian`, lastModified: now, changeFrequency: 'weekly', priority: 0.8 },
    { url: `${BASE}/languages/thai`, lastModified: now, changeFrequency: 'weekly', priority: 0.8 },
    { url: `${BASE}/languages/russian`, lastModified: now, changeFrequency: 'weekly', priority: 0.8 },
    { url: `${BASE}/languages/portuguese`, lastModified: now, changeFrequency: 'weekly', priority: 0.8 },
    { url: `${BASE}/languages/polish`, lastModified: now, changeFrequency: 'weekly', priority: 0.8 },
    { url: `${BASE}/languages/hindi`, lastModified: now, changeFrequency: 'weekly', priority: 0.8 },
