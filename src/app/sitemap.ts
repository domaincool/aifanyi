...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${BASE}/understand/slang`, lastModified: now, changeFrequency: 'daily', priority: 0.9 },
    { url: `${BASE}/understand/dictionary`, lastModified: now, changeFrequency: 'weekly', priority: 0.8 },
    { url: `${BASE}/understand/idioms`, lastModified: now, changeFrequency: 'daily', priority: 0.9 },
