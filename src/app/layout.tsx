...
export const metadata: Metadata = {
  ...
  description: '爱翻译在线翻译：免费在线使用，英文翻译成中文、中文翻译成英文，支持实时智能翻译，翻译准确自然。跨境电商文案、外文文档、网络用语都能翻，多模型对比选更佳译文。',
  keywords: ['在线翻译', '英文翻译成中文', '中文翻译成英文', '智能翻译', '实时翻译', '免费翻译', '爱翻译'],
  openGraph: {
    title: '爱翻译 - 在线翻译,英文翻译成中文,智能翻译,实时翻译',
    description: '爱翻译在线翻译：免费在线使用，英文翻译成中文、中文翻译成英文，支持实时智能翻译，翻译准确自然。网络用语、外文文档、跨境电商文案都能翻，多模型对比选更佳译文。', /* __p0b-l18__ */
